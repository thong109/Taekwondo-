                        ...
                        <div class="card mb-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="input2" class="col-sm-2 text-right">Chất liệu</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="material" value="<?php echo $EditProduct['material'] ?>">
                                     </div>
                               
                                    <label for="input2" class="col-sm-1 text-right">Kích thước</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="top" value="<?php echo $EditProduct['top'] ?>">
                                     </div>
                                 </div>

                                 <div class="form-group row">
                                    <label for="input2" class="col-sm-2 text-right">Xuất sứ</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="mid" value="<?php echo $EditProduct['mid'] ?>">
                                     </div>
  
                                    <label for="input2" class="col-sm-1 text-right">Trọng lượng</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="down" value="<?php echo $EditProduct['down'] ?>">
                                     </div>
                                 </div>
                                <div class="form-group row">
