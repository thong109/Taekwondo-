<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if(empty($error))
        {
            ...
            if(count($isset) > 0 && $Edittintuc['name'] != $data['name'])
            {
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-8">
                                      <select class="form-control" name="category_id">
                                        ...
                                        <?php foreach ($category as $item): ?>
                                            <option value="<?php echo $item['id'] ?>" <?php echo $Edittintuc['category_id'] == $item['id'] ? "selected = 'selected'" : "" ?>><?php echo $item['name'] ?></potion>
                                        <?php endforeach ?>
                                      </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" class="form-control" id="input1" name="name" value="<?php echo $Edittintuc['name'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      ...
                                      <img src="<?php echo uploads(); ?>product/<?php echo $Edittintuc['thundar'] ?>" width="50px" height="50px">
