...
$dem2 = $db->total($sql2);
 ...
 if (isset($_GET['page']))
    ...
    $sql = "SELECT transaction.* FROM transaction ORDER BY ID ASC ";
    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">thống kê sản phẩm đã bán (Bao gồm 5% thuế)</li>
            </ol>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul style="list-style: none;">
                                        <li>Giá: <?php echo $item['priceproduct']* 105/100 ?></li>
