<link rel="stylesheet" type="text/css" href="style.css"><!-- Available in two variations: "light" and "dark" | Change <header> class to see impact. -->
<header class="dark">
  <nav role="navigation">
...
<div class="author">
  Created by: <a href="https://www.linkedin.com/in/rathoreahsan/" target="_blank">Ahsan Khurshid</a>
</div>