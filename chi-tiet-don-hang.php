 	 ...
 	 <div class="box-main1 container">
        ...
        <table class="table table-striped">
		  ...
		  <tbody>
		  	<?php if (count($order)>0): ?>
		  		<?php $stt=1;$sum=0 ;foreach ($order as $item): ?>
				      ...
				      <td><?php echo formatPrice($item['price']*$item['qty']*105/100) ?> đ</td>
				    </tr>
		  ...
		  <tfoot>
		      ...
		      <th scope="col" style="color: red"><?php echo formatPrice($sum*105/100) ?> đ</th>
		    </tr>
		   </tfoot>
		   <?php else: ?>
		   	<tr>
